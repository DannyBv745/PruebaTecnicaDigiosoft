...
<?php if(session() -> getFlashdata('error') !== null) { ?>
    ...
    <form action="<?= base_url('libros') ?>" class="row g-3" method="post" autocomplete="off">
        
        <div class="container-fluid" style="margin-bottom: 10%;">
            <div class="card mb-3" style="max-width: 50rem; margin:auto; margin-top:30px; ">
                <div class="card-header text-center bg-primary">
                    <h4 class="text-white">Agregar nuevo idioma</h4>
                </div>
                <div class="card-body">
                    <div class="form-floating mb-3 mt-4">
                        <input class="form-control" type="text" name="li_titulo" placeholder="Titulo">
                        ...
                        <div class="form-floating mb-3 mt-4 col" style="height: 4rem;">
                            <select class="form-select" name="li_autor" id="li_autor">
                                ...
                                <?php foreach ($autores as $autor) : ?>
                                    <option value="<?= $autor['au_id']; ?>"><?= $autor['au_nombre'] . ' ' . $autor['au_apaterno'] . ' ' . $autor['au_amaterno']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-floating mb-3 mt-4 col">
                            <select class="form-select" name="li_editorial" id="li_editorial">
                                ...
                                <?php foreach ($editorial as $editorial) : ?>
                                    <option value="<?= $editorial['ed_id']; ?>"><?= $editorial['ed_nombre']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-floating mb-3 mt-4 col">
                            <select class="form-select" name="li_idioma" id="li_idioma">
                                ...
                                <?php foreach ($idiomas as $idioma) : ?>
                                    <option value="<?= $idioma['idi_id']; ?>"><?= $idioma['idi_nombre']; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <label for="floatingInput" style="margin-left: 1rem;">Idioma</label>
                        </div>
                        <div class="form-floating mb-3 mt-4 col">
                        <input class="form-control" type="text" name="li_numejemplares" placeholder="Ejemplares">
