...
<div class="container-fluid" style="margin-bottom: 10%;">
    <div class="card mb-3" style="max-width: 90rem; margin:auto; margin-top:30px; ">
        <div class="card-header text-center bg-primary">
            <h4 class="text-white">Prestamos</h4>
        </div>
        <div class="card-body">
            ...
            <table class="table table-hover table-bordered">
                <thead>
                    ...
                    <th scope="col" style="width: 20%;">Prestamo</th>
                    <th scope="col" style="width: 20%;">Devolución</th>
                    <th scope="col" style="width: 20%;">Usuario</th>
                    <th scope="col" style="width: 20%;">Ejemplar</th>
                ...
                <?php foreach ($prestamos as $prestamo): ?> 
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#eliminaModal" data-bs-url="<?= base_url('prestamos/'.$prestamo['pr_id']); ?>" style="width: 5rem">Borrar</button>
                        </td>
            ...
            <div class="container text-center mt-4">
                <a href="<?= base_url('prestamos/new') ?>" class="btn btn-primary">Nuevo</a>
            </div>
        </div>
    </div>
</div>
