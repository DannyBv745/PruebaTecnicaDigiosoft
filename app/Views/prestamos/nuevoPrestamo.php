...
<?php if(session() -> getFlashdata('error') !== null) { ?>
    ...
    <form action="<?= base_url('prestamos') ?>" class="row g-3" method="post" autocomplete="off">
        
    <div class="container-fluid" style="margin-bottom: 10%;">
            <div class="card mb-3" style="max-width: 50rem; margin:auto; margin-top:30px; ">
                <div class="card-header text-center bg-primary">
                    <h4 class="text-white">Agregar nuevo prestamo</h4>
                </div>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="form-floating mb-3 mt-4 col">
                            <input class="form-control" type="date" name="pr_prestamo" placeholder="Prestamo" id="date-input">
                            <label for="floatingInput" style="margin-left: 1rem;">Prestamo</label>
                        </div>
                        <div class="form-floating mb-3 mt-4 col" style="height: 4rem;">
                            <input class="form-control" type="date" name="pr_devolucion" placeholder="Devolucion">
                        ...
                        <div class="form-floating mb-3 mt-4 col">
                            <select class="form-select" name="pr_usuario" id="pr_usuario">
                                ...
                                <?php foreach ($usuarios as $usuario) : ?>
                                    <option value="<?= $usuario['us_id']; ?>"><?= $usuario['us_user']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-floating mb-3 mt-4 col">
                            <select class="form-select" name="pr_ejemplar" id="pr_ejemplar">
                                ...
                                <?php foreach ($ejemplares as $ejemplar) : ?>
                                    <option value="<?= $ejemplar['ej_id']; ?>"><?= $ejemplar['ej_libro'] . ', ' . $ejemplar['ej_numejemplar']; ?></option>
                                <?php endforeach; ?>
                            </select>
