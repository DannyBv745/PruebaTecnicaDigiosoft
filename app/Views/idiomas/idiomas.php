...
<div class="container-fluid" style="margin-bottom: 10%;">
    <div class="card mb-3" style="max-width: 50rem; margin:auto; margin-top:30px; ">
        <div class="card-header text-center bg-primary">
            <h4 class="text-white">Idiomas</h4>
        </div>
        <div class="card-body">
            ...
            <table class="table table-hover table-bordered">
                <thead>
                    ...
                    <th scope="col" style="width: 15%;">Abreviación</th>
                ...
                <?php foreach ($idiomas as $idioma): ?> 
                    <tr>
                        <td><?= $idioma['idi_id']; ?></td>
                        <td><?= $idioma['idi_nombre']; ?></td>
                        <td><?= $idioma['idi_abreviacion']; ?></td>
                        <td>
                            <a href="<?= base_url('idiomas/'.$idioma['idi_id'].'/edit'); ?>" class="btn btn-warning" style="width: 5rem">Editar</a>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#eliminaModal" data-bs-url="<?= base_url('idiomas/'.$idioma['idi_id']); ?>" style="width: 5rem">Borrar</button>
                        </td>
            ...
            <div class="container text-center mt-4">
                <a href="<?= base_url('idiomas/new') ?>" class="btn btn-primary">Nuevo</a>
            </div>
        </div>
    </div>
</div>
