    ...
    <div class="card mb-3" style="max-width: 50rem; margin:auto; margin-top:30px; ">
        ...
        <div class="card-body">
            ...
            <table class="table table-hover table-bordered">
                ...
                <?php foreach ($categorias as $categoria): ?> 
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('categorias/'.$categoria['cat_id'].'/edit'); ?>" class="btn btn-warning" style="width: 5rem">Editar</a>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#eliminaModal" data-bs-url="<?= base_url('categorias/'.$categoria['cat_id']); ?>" style="width: 5rem">Borrar</button>
                        </td>
            ...
            <div class="container text-center mt-4">
                <a href="<?= base_url('categorias/new') ?>" class="btn btn-primary">Nuevo</a>
            </div>
        </div>
    </div>
</div>
