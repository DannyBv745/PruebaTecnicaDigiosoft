        ...
        <div class="card-body">
            ...
            <table class="table table-hover table-bordered">
                <thead>
                    ...
                    <th scope="col" style="width: 32%;">Ubicacion</th>
                    <th scope="col" style="width: 31%;">Opciones</th>
                    </tr>
                </thead>
                ...
                <?php foreach ($editorial as $editorial): ?> 
                    <tr>
                        <td><?= $editorial['ed_id']; ?></td>
                        <td><?= $editorial['ed_nombre']; ?></td>
                        <td><?= $editorial['ed_ubicacion']; ?></td>
                        <td>
                            <a href="<?= base_url('editorial/'.$editorial['ed_id'].'/edit'); ?>" class="btn btn-warning" style="width: 5rem">Editar</a>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#eliminaModal" data-bs-url="<?= base_url('editorial/'.$editorial['ed_id']); ?>" style="width: 5rem">Borrar</button>
                        </td>
            ...
            <div class="container text-center mt-4">
                <a href="<?= base_url('editorial/new') ?>" class="btn btn-primary">Nuevo</a>
            </div>
        </div>
    </div>
</div>
