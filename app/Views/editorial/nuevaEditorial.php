...
<?php if(session() -> getFlashdata('error') !== null) { ?>
    ...
    <form action="<?= base_url('editorial') ?>" class="row g-3" method="post" autocomplete="off">
            ...
            <div class="card mb-3" style="max-width: 50rem; margin:auto; margin-top:30px; ">
                ...
                <div class="card-body">
                    <div class="form-floating mb-3 mt-4">
                        <input class="form-control" type="text" name="ed_nombre" placeholder="Nombre">
                        <label for="floatingInput">Nombre</label>
                    </div>
                    <div class="form-floating mb-3 mt-4">
                        <input class="form-control" type="text" name="ed_ubicacion" placeholder="Ubicacion">
